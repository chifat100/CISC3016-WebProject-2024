...
public class WebPageWriter {
  ...
  /**
 * Method to create a page with thumbnails of all the images
 * in a directory
...
public void createImagePage(String directory)
{
  ...
  try {
   ...
   // get the array of items in the directory
 ...
 * @throws IOException
 */
private void writeStart(BufferedWriter writer) throws
  IOException
{
 ...
 * @throws IOException
 */
private void writeHead(BufferedWriter writer, String title)
  throws IOException
{
 ...
 * @throws IOException
 */
private void writeBody(BufferedWriter writer, String body)
  throws IOException
{
 ...
 * @throws IOException
 */
private void writeEnd(BufferedWriter writer)
  throws IOException
{
  writer.write("</html>");
}
 ...
 public static void main(String[] args)
 {
   ...
   String dir = "D:/Multimedia Computing/lab/mediasources/";
