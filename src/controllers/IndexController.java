...
public class IndexController extends Controller {
    ...
    public Object index(@FromRoute("word") String word) throws IOException {
        ...
        // htmlContent += "<audio controls><source src='sound.wav'
        // type='audio/mpeg'>Your browser does not support the audio element.</audio>";
        // htmlContent += "<img src='image.jpeg' alt=' '>";
        // htmlContent += "<script>function enlargeImage(img) { img.style.transform =
        // 'scale(1.5)'; img.style.transition = 'transform 0.25s ease'; }
        // document.querySelectorAll('img').forEach(img => img.addEventListener('click',
        // () => enlargeImage(img)));</script>";
        // htmlContent += "</body></html>";
        //
        // htmlContent += "<h2>Spell Check</h2>";
        // htmlContent += "<form action='/SpellCheckApp/checkSpelling' method='get'>";
        // htmlContent += "<label for='word'>Enter a word to check its
        // spelling:</label>";
        ...
        // FileWriter("src/aggregatedContent.html"));
